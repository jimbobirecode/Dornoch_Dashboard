    ...
    <div className="stack">
      ...
      {data && (
        <>
          ...
          <ChartCard
            title="Tee sheet utilisation"
            subtitle={`Weekday against time of day${
              data.utilisation.placed ? '' : ' — no booking in this period carries a usable tee time'
            }`}
            footer={
              <TableView
                label="the numbers"
          ...
          >
            <Heatmap
              cells={data.utilisation.cells}
              days={data.utilisation.days}
              bands={data.utilisation.bands}
              emptyMessage="No booking in this period has a tee time to place."
            />
          </ChartCard>
